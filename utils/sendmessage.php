...
if(!isset($_FILES['attach_file']))
 ...
 if(strlen($text) < 2) {
	   echo '<META HTTP-EQUIV="Refresh" Content="0; URL=../messages.php?to='.$_POST['to_id'].'&error=message">';
	  exit;
  }
...
mysql_select_db($mysql_database, $mysql_link);
  	...
  	$query="INSERT INTO message (mid, from_uid, to_uid, didread, subject, text, type, datetime) VALUES  ('0','$uid','$to_id','0','$subject','$text', '1', '$today')";
	...
	echo '<META HTTP-EQUIV="Refresh" Content="0; URL=../profile.php?id='.$to_id.'">';
?>