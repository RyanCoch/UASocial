...
<link rel="shortcut icon" href="images/gicon.ico" type="image/x-icon" />
...
function textarea(length, text) {
	...
	function pchat(to_id) {
		$.post("utils/init_pchat.php", {to: to_id});
		displayChat(to_id);
	}
</script>

<script type="text/javascript" src="js/pchat.js"></script>
<script type="text/javascript" src="utils/encript.js"></script>
<script type="text/javascript" src="utils/custom.js"></script>
...
<script type="text/javascript">
	function loadmessage(){		
		$.ajax({
			url: "newmsg.php?<?php if ($am_i_in_chat) echo "chat=1";?>",
			cache: false,
...
if(isset($_SESSION['uid'])) :
	...
	<p class="topmenu">
		...
		<a href="search.php" class="last"><img src="images/<?php if($css=="1")echo"minimal/";if($css=="2")echo"alt/";?>lupa.png" height="30" />Search</a>	
		<a href="chat.php" class="last"><img src="images/<?php if($css=="1")echo"minimal/";if($css=="2")echo"alt/";?>chat.png" height="30" />Chat room</a>	
		<a href="myprofile.php" class="last"><img src="<?php if (file_exists("pictures/".$picture."30.jpg")) echo "pictures/".$picture."30.jpg"; else echo "pictures/0/boy30.jpg"; ?>" alt="My Face" width="30" height="30" /> <?php echo $name;?></a>
	</p>
	</div>
